...
clear
#echo -e "${red}♦️${NC} ${green}Established By kenDevXD 2022${NC} ${red}♦️${NC}"
...
#wget -q -O /usr/share/nginx/html/index.html "https://raw.githubusercontent.com/kenDevXD/kepo/main/OTHERS/index.html"
...
echo -e "${RB}      '-------------------------------------------'${NC}"
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
echo -e "      ${WB}Multiport Websocket Autoscript By kenDevXD${NC}"
echo -e "${BB}————————————————————————————————————————————————————————${NC}"
